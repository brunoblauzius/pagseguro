...
class CreatePaymentRequest
{
    ...
    public static function main()
    {
        ...
        $paymentRequest->addItem('0001', 'Lincença Starter - Sistema de gerenciamento AGENTUS', 1, 30.00);
        ...
        $paymentRequest->setReference("STARTER_30");
        ...
        $paymentRequest->setRedirectUrl("http://agentus.com.br/sistema/pagamentos/information");
        ...
        $paymentRequest->addParameter('notificationURL', 'http://agentus.com.br/sistema/pagamentos/notification');
